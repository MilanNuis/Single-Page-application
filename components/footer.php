...
?>
<footer class="overflow-hidden bg-gradient-to-r from-red-500 to-red-700 rounded-t-2xl" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-16">
            ...
            <div class="mt-10 xl:mt-0">
                ...
                <form class="mt-6 sm:flex sm:max-w-md" method="post" action="../controllers/newsLetter.php">
                    ...
                    <div class="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                        <button type="submit" class="flex w-full items-center justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo">Abonneer</button>
                    </div>
                </form>
        ...
        <div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
            ...
            <p class="mt-8 text-xs leading-5 text-white md:order-1 md:mt-0">&copy; 2024 PMOT, All rights reserved.</p>
        </div>
    </div>
</footer>